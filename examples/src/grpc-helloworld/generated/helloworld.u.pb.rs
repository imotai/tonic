...
unsafe impl ::protobuf::__internal::runtime::UpbGetMessagePtrMut for HelloRequest {
    ...
    fn get_ptr_mut(
        &mut self,
        _private: ::protobuf::__internal::Private,
    ) -> ::protobuf::__internal::runtime::MessagePtr<HelloRequest> {
        self.inner.ptr_mut()
    }
}
...
pub(crate) static mut helloworld__HelloReply_msg_init: ::protobuf::__internal::runtime::MiniTableInitPtr = ::protobuf::__internal::runtime::MiniTableInitPtr(
    ::protobuf::__internal::runtime::MiniTablePtr::dangling(),
);
#[allow(non_camel_case_types)]
...
impl<'msg> From<::protobuf::__internal::runtime::MessageViewInner<'msg, HelloReply>>
for HelloReplyView<'msg> {
    fn from(
        inner: ::protobuf::__internal::runtime::MessageViewInner<'msg, HelloReply>,
    ) -> Self {
        Self { inner }
...
impl<'msg> From<::protobuf::__internal::runtime::MessageMutInner<'msg, HelloReply>>
for HelloReplyMut<'msg> {
    fn from(
        inner: ::protobuf::__internal::runtime::MessageMutInner<'msg, HelloReply>,
    ) -> Self {
        Self { inner }
...
impl HelloReply {
    ...
    pub fn as_message_mut_inner(
        &mut self,
        _private: ::protobuf::__internal::Private,
    ) -> ::protobuf::__internal::runtime::MessageMutInner<'_, HelloReply> {
        ::protobuf::__internal::runtime::MessageMutInner::mut_of_owned(&mut self.inner)
    }
...
unsafe impl ::protobuf::__internal::runtime::AssociatedMiniTable for HelloReply {
    fn mini_table() -> ::protobuf::__internal::runtime::MiniTablePtr {
        ...
        unsafe {
            ONCE_LOCK
                .get_or_init(|| {
                    super::helloworld__HelloReply_msg_init.0 = ::protobuf::__internal::runtime::build_mini_table(
                        "$M1P",
                    );
                    ::protobuf::__internal::runtime::link_mini_table(
...
unsafe impl ::protobuf::__internal::runtime::UpbGetMessagePtrMut for HelloReply {
    ...
    fn get_ptr_mut(
        &mut self,
        _private: ::protobuf::__internal::Private,
    ) -> ::protobuf::__internal::runtime::MessagePtr<HelloReply> {
        self.inner.ptr_mut()
    }
}
